...
@section('content')
    ...
    <div class="flex items-center justify-center py-4 md:py-8 flex-wrap">
        ...
        @foreach ($categories as $item)
            <button type="button"
                class="text-gray-900 border border-white hover:border-gray-200  bg-white focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-full text-base font-medium px-5 py-2.5 text-center me-3 mb-3 ">{{ $item->name }}</button>
        @endforeach
